...
| [Operation lifecycle v2](FILE-LIFECYCLE.md) | Stable logical IDs, honest terminal states and cancellation with independent authority |
| [Native lifecycle negotiation](FILE-NEGOTIATION.md) | Versioned method selection, reviewed digests and current connection identity |
