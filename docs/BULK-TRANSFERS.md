...
- **Still required before this issue closes:** measured user-stack headroom for a `MAX_MESSAGE`-sized buffer in a client, rather than the current evidence that the applications run without faulting.
