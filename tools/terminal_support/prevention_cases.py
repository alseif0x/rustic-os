...
def exercise(uart, data):
    ...
    selection = selection_cases.exercise(uart, data, ws, resource)
    ...
    return {"verified": True, "format": 5, "legacy_cause": "unknown", "lifecycle": lifecycle, "negotiation": negotiation, "selection": selection,
